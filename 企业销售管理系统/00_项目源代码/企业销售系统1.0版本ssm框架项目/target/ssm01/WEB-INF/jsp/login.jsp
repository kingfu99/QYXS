...
<html>
	...
	<body>
		...
		<div class="login_main">
			...
			<div class="form_tzgg">
				<div class="form">
					<form action="/user/dologin" method="post" class="layui-form" onsubmit="return fn()">
				...
				<script>
                    ...
                    function fn() {
                        ...
                        if (myUserName.value == "ying") {
                            if (myPassWord.value == "123456") {
				...
				<div class="tzgg">
					...
					<div class="con">
						<ul>
							<li><span>08-08</span><a href="#" target="_blank">企业销售系统升级</a></li>
							<li><span>08-16</span><a href="#" target="_blank">企业销售系统上线</a></li>
							<li><span>08-20</span><a href="#" target="_blank">企业销售系统维护中，敬请期待</a></li>
						</ul>
					</div>
				</div>
			</div>
