		...
		<div class="frameMenu">
		    ...
		    <div class="menu">
		        ...
		        <ul>
		        	...
		        	<li>
		                <a class="menuFA" href="javascript:void(0)"><i class="iconfont icon-icon left" onmouseenter="getLeftTips(this, '打印模板')" onmouseleave="layer.closeAll('tips')"></i><font>日志模板</font><i class="iconfont icon-dajiantouyou right"></i></a>
		                <dl>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/print/outPrintData.jsp',this, 'page10034')">打印单打印模版</a></dt>
		                </dl>
		           	</li>
		        	<li>
