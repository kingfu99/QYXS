	...
	<body>
		...
		<div class="frameMenu">
		    ...
		    <div class="menu">
		        ...
		        <ul>
		        	<li>
		                <a class="menuFA" href="javascript:void(0)" onclick="menuCAClick('../tgls/iconfont.jsp',this, 'page10002')"><i class="iconfont icon-huojian left" onmouseenter="getLeftTips(this, 'iconfont字体库')" onmouseleave="layer.closeAll('tips')"></i><font>iconfont字体库</font></a>
		            </li>
		        	<li>
		                ...
		                <dl>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/agent/agent_add.jsp',this, 'page10022')">添加代理商</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/agent/agent_list1.jsp',this, 'page10023')">代理商列表</a></dt>
		                </dl>
		            </li>
		        	<li>
		        	...
		        	<li>
		                ...
		                <dl>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/base/base_add.jsp',this, 'page10028')">表单含编辑器</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/base/base_list.jsp',this, 'page10029')">常用列表</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/base/base_customList.jsp',this, 'page10030')">可新增的列表</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/base/base_customNewList.jsp',this, 'page10031')">可新增的列表(手写)</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/base/pages.jsp',this, 'page10032')">页签切换Table</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/base/maintain.jsp',this, 'page10033')">维护中页面</a></dt>
		                </dl>
		           	</li>
		        	<li>
		                ...
		                <dl>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/print/outPrintData.jsp',this, 'page10033')">打印单打印模版</a></dt>
		                </dl>
		           	</li>
		        	<li>
		        	...
		        	<li>
		                ...
		                <dl>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/into_out/outData.jsp',this, 'page10036')">入库管理</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/into_out/intoData.jsp',this, 'page10037')">出库管理</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('../tgls/into_out/outPrintData.jsp',this, 'page10038')">打印单打印模版</a></dt>
		                </dl>
		           </li>
		        </ul>
		    </div>
		...
		<div class="main">
			...
			<div class="frameTop">
				...
				<div class="topMenu">
		    		<div class="hoverBox"></div>
					<ul>
						<li><a href="javascript:void(0)" onclick="menuCAClick('tgls/modify_password.jsp',this, 'pageNotice', '通知公告')" onmouseenter="getTips(this, '通知公告')" onmouseleave="layer.closeAll('tips')"><i class="iconfont icon-tongzhigonggao1"></i><span class="news"></span></a></li>
						...
						<li>
							...
							<dl>
			                	<dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/modify_password.jsp',this, 'pageUserInfo')">基本资料</a></dt>
			                	<dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/modify_password.jsp',this, 'pageModifyPassword')">修改密码</a></dt>
			                </dl>
						</li>
						<li><a href="login" onmouseenter="getTips(this, '退出系统')" onmouseleave="layer.closeAll('tips')"><i class="iconfont icon-084tuichu"></i></a></li>
					</ul>
				</div>
			</div>
			<!-- 头部栏 - 结束 -->
