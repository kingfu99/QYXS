...
<head>
	...
	<body>
		<div class="cBody" >
			<div class="console"  >
				<form id=sform class="layui-form" method=post action="/sysLog/findAll">
				...
				<%--		<div class="layui-input-inline" >
						...
						&lt;%&ndash;<button class="layui-btn" lay-submit lay-filter="submitBut">检索</button>&ndash;%&gt;
						<div class="layui-input-inline">
			...
			<table class="layui-table">
				...
				<c:forEach items="${pageInfo.list}" var="syslog">
					<tr>
						...
						<td>${syslog.aopId}</td>
						<td>${syslog.aopTime }</td>
						<td>${syslog.aopName}</td>
						<td>${syslog.aopIp}</td>
						<td>${syslog.aopUrl}</td>
						<td>${syslog.aopLong}毫秒</td>
						<td>${syslog.aopMethod}</td>
					</tr>
				</c:forEach>
