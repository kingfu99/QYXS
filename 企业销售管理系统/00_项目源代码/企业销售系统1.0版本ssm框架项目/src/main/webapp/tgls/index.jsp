...
<html>
	...
	<body>
			...
			<div class="cBody_padding">
				<div class="row">
					<div class="custom_6 totalAmount">
						<div class="type">
							<span onclick="totalAmountDataRefresh()">2018年月销售额<font class="active"></font></span>
							<span onclick="totalAmountDataRefresh()"><font></font></span>
							<span onclick="totalAmountDataRefresh()">12月日销售额<font></font></span>
						</div>
						<%--<div class="title">
				...
				<div class="row m_t">
					...
					<div class="custom_5 orderMap">
						<div class="type">
							<span onclick="orderMapDataRefresh()">近一周<font class="active"></font></span>
		...
		<script>
			$(function(){
				//总金额
				var totalAmount = [{"2018-06":133047.83,},{"2018-07":12656.4},{"2018-08":90414.97},{"2018-09":93442.64},{"2018-10":136781.31},{"2018-11":160118.31},{"2018-12":155682.17}];
				//前端周期活跃度
				var weekActive = [
				...
				//订单分布图
				var orderMap = [
					[{"12-23":8617.68},{"12-24":5996.95},{"12-25":2747},{"12-26":0 },{"12-27":7959.55},{"12-28":9057.2},{"12-29":2511.1}],
					[{"12-23":15},{"12-24":11},{"12-25":5},{"12-26":0 },{"12-27":6},{"12-28":10},{"12-29":9}]
				];
				//前端增长图
			...
			function totalAmountDataRefresh(){
				...
				var data = [[{"12-23":8617.68},{"12-24":5996.95},{"12-25":2747},{"12-26":0 },{"12-27":7959.55},{"12-28":9057.2},{"12-29":2511.1}]];
			...
			function orderMapDataRefresh(){
				...
				var data = [
					[{"2018-49":35023.98},{"2018-50":30052.65},{"2018-51":41490.54},{"2018-52":28271.8}],
					[{"2018-49":76},{"2018-50":63},{"2018-51":68},{"2018-52":41}]
				];
			...
			function merchantGraphDataRefresh(){
				...
				var data = [[{"7月25日":10},{"7月26日":31},{"7月27日":32},{"7月28日":34},{"7月29日":40},{"7月30日":50}]];
